...
**Working directory:** candidates/cand-0005/workspaces/search-001
...
**Input:** The task description above + the project files in candidates/cand-0005/workspaces/search-001
**Output:** Write `plan.md` to candidates/cand-0005/workspaces/search-001/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0005/workspaces/search-001/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0005/workspaces/search-001/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0005/workspaces/search-001/ with this EXACT format:
