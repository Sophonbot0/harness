...
**Description:** Replace all bare try/except blocks with proper error handling: custom exception classes, structured error responses, error logging with context, and a global error handler.
**Working directory:** candidates/cand-0005/workspaces/search-009
...
**Input:** The task description above + the project files in candidates/cand-0005/workspaces/search-009
**Output:** Write `plan.md` to candidates/cand-0005/workspaces/search-009/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0005/workspaces/search-009/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0005/workspaces/search-009/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0005/workspaces/search-009/ with this EXACT format:
