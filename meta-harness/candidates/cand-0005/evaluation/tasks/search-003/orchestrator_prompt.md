...
**Description:** Refactor a payment processing module from a giant if/else chain to the Strategy pattern. Support credit card, PayPal, and bank transfer. Maintain backwards compatibility.
**Working directory:** candidates/cand-0005/workspaces/search-003
...
**Input:** The task description above + the project files in candidates/cand-0005/workspaces/search-003
**Output:** Write `plan.md` to candidates/cand-0005/workspaces/search-003/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0005/workspaces/search-003/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0005/workspaces/search-003/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0005/workspaces/search-003/ with this EXACT format:
