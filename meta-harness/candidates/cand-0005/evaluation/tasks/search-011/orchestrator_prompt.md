...
## Task
**Name:** Sprint-Sized Project
**Description:** Build a URL shortener service: URL creation API, redirect handler, click analytics tracking, rate limiting, admin dashboard (list all URLs, see click counts), and database persistence. Must have tests.
**Working directory:** candidates/cand-0005/workspaces/search-011
...
**Input:** The task description above + the project files in candidates/cand-0005/workspaces/search-011
**Output:** Write `plan.md` to candidates/cand-0005/workspaces/search-011/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0005/workspaces/search-011/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0005/workspaces/search-011/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0005/workspaces/search-011/ with this EXACT format:
