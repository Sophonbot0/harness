...
## Task
**Name:** Existing Codebase Bug Hunt
**Description:** The test suite has 3 failing tests. Fix all 3 bugs without breaking anything else. The bugs are in different modules and have different root causes (off-by-one, race condition, type coercion).
**Working directory:** candidates/cand-0006/workspaces/search-012
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-012
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-012/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-012/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-012/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-012/ with this EXACT format:
