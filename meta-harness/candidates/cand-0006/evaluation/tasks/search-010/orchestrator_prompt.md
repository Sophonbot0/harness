...
**Description:** Build a configuration system that loads from: defaults → config file (YAML) → environment variables → CLI flags. Support nested keys, type coercion, and validation with helpful error messages.
**Working directory:** candidates/cand-0006/workspaces/search-010
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-010
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-010/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-010/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-010/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-010/ with this EXACT format:
