...
**Description:** Write a database migration that adds a 'tags' column (JSON array), migrates existing 'category' data into tags, and provides a rollback script. Must handle tables with 100K+ rows.
**Working directory:** candidates/cand-0006/workspaces/search-005
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-005
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-005/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-005/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-005/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-005/ with this EXACT format:
