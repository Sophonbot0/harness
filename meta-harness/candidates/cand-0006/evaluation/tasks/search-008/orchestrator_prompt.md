...
**Working directory:** candidates/cand-0006/workspaces/search-008
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-008
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-008/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-008/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-008/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-008/ with this EXACT format:
