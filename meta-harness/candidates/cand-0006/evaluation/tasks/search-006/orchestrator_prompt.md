...
**Description:** Implement a sliding-window rate limiter middleware. Support per-IP and per-API-key limits. Return 429 with Retry-After header. Include bypass for health check endpoints.
**Working directory:** candidates/cand-0006/workspaces/search-006
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-006
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-006/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-006/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-006/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-006/ with this EXACT format:
