...
**Description:** Build a CLI tool with 3 subcommands: 'init' (create config file), 'run' (execute pipeline), 'status' (show current state). Include --help, --verbose flags, and proper exit codes.
**Working directory:** candidates/cand-0006/workspaces/search-004
...
**Input:** The task description above + the project files in candidates/cand-0006/workspaces/search-004
**Output:** Write `plan.md` to candidates/cand-0006/workspaces/search-004/plan.md
...
**Output:** Write `challenge-report.md` to candidates/cand-0006/workspaces/search-004/challenge-report.md
...
**Output:** Write `eval-report.md` to candidates/cand-0006/workspaces/search-004/eval-report.md
...
5. At the end, write a `scores.json` to candidates/cand-0006/workspaces/search-004/ with this EXACT format:
